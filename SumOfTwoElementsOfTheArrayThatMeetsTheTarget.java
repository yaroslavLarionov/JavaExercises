...
public class SumOfTwoElementsOfTheArrayThatMeetsTheTarget {
	public static void main(String[] args) {

		// TODO write a method that accepts int array and int target and returns int
		// array where the sum of 2 elements of the array equals the target
